...
class QualityCheck_Page {
    ...
    // Quality checks are now rendered inline within review cards via JavaScript.
    // See papertable.php::print_review_quality_checks() and script.js::add_review_quality_check().
}
